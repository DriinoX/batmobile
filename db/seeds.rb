...
10.times do
  ...
  puts 'User create'
  phone = Phone.create!(state: ['Correct', 'Bon etat', 'Tres bon etat'].sample, user: had, start_dispo: Faker::Date.in_date_period, end_dispo: Faker::Date.in_date_period, brand: ['Apple', 'Samsung', 'Huawei', 'Xiaomi'].sample, model: 'Iphone X', description: Faker::Lorem.word, price: rand(1..10), address: Faker::Address.full_address )
  puts 'Phone create'
end
puts 'DONE'
